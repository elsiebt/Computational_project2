...
theta0=c(1914.177,	9655.250,	1786.733,	1.963606)
...
block2(theta0[1], theta0[2], theta0[3], theta0[4],3)
...
MCMC_block <- function(theta, n, sigma.t1, sigma.beta){
  ...
  block1(t1[i-1], lambda0[i-1], lambda1[i-1], beta[i-1], sigma.t1)
...
eta <- rep(3,n)
eta[n/2]<-4
samples<-gibbs_block(eta,n, 2000)
